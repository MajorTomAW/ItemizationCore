...
#include "SItemDefinitionEditorAssetType.h"
...
void SItemDefinitionEditorAssetType::Construct(
...
FText SItemDefinitionEditorAssetType::HandleGetAssetTypeText() const
{
...
const FSlateBrush* SItemDefinitionEditorAssetType::HandleGetAssetTypeIcon() const
{
	TSharedPtr<IItemDefinitionApplication> AppPtr = WeakApp.Pin();
...
UClass* SItemDefinitionEditorAssetType::GetAssetClass() const
{
	TSharedPtr<IItemDefinitionApplication> AppPtr = WeakApp.Pin();
	if (!AppPtr.IsValid()) return nullptr;
