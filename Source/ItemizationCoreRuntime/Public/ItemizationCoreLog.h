...
{
	ITEMIZATIONCORERUNTIME_API FString GetItemizationClientServerContextString(const UObject* Object);
...
#define ITEMIZATION_Net_LOG(Verbosity, Object, Format, ...) \
	UE_LOG(LogInventorySystem, Verbosity, TEXT("%s: ") Format, *GetItemizationClientServerContextString(Object), ##__VA_ARGS__)
}
